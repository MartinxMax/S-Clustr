...
public class ServerMain {
    ...
    private static String s_key = generatePassword(8); // Default value, can be generated randomly
    private static String r_key = generatePassword(8); // Default value, can be generated randomly
            ...
            while (true) {
                try {
                    ...
                    try {
                        ...
                        // Close the socket to prevent server issues from malformed packets
...
//    }
    ...
    public static void startUdpServer() {
        try {
            DatagramSocket socket = new DatagramSocket(10089);
            ...
            while (true) {
                ...
                String decodedMessage = CORE.anonymousDecode(r_key, message);
                ...
                byte[] sendData = decodedMessage.getBytes();
