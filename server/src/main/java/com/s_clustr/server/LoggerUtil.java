...
public class LoggerUtil {
    ...
    public static void printInfo(String message) {
        logger.info(Ansi.ansi().fg(Ansi.Color.GREEN).bold().a("[INFO] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printError(String message) {
        logger.severe(Ansi.ansi().fg(Ansi.Color.RED).bold().a("[ERROR] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printSuccess(String message) {
        logger.info(Ansi.ansi().fg(Ansi.Color.GREEN).bold().a("[SUCCESS] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printWarning(String message) {
        logger.warning(Ansi.ansi().fg(Ansi.Color.YELLOW).bold().a("[WARNING] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printForward(String message) {
        logger.info(Ansi.ansi().fg(Ansi.Color.CYAN).bold().a("[FORWARD] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printDevice(String message) {
        logger.info(Ansi.ansi().fg(Ansi.Color.MAGENTA).bold().a("[DEVICE] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }

    public static void printAnonymous(String message) {
        logger.info(Ansi.ansi().fg(Ansi.Color.CYAN).bold().a("[ANONYMOUS] ").boldOff().fgBrightBlack().a(message).reset().toString());
    }
